...
#     """Brauzer ma'lumotlarini aniqlash"""
#     browsers = {
#         'Chrome': 'Chrome',
#         'Firefox': 'Firefox',
#         'Safari': 'Safari',
...
#         device = data.get('device', 'Noma\'lum')
#         platform = data.get('platform', 'Noma\'lum')
#         name = data.get('name', 'Noma\'lum')
#         screen = data.get('screen', 'Noma\'lum')
#         language = data.get('language', 'Noma\'lum')
        
#         # Qo'shimcha ma'lumotlar
#         location = get_location(ip)
#         browser = get_browser_info(device)
#         current_time = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        
#         # Telegramga yuboriladigan xabar
#         message = f"""
# <b>🆕 Yangi vizitka kirishi!</b>
...
#     app.run(host='http://127.0.0.1:5001/notify', port=5001, debug=True)
